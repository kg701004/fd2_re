...
| 領域 | 已驗證成果 | 與原版的差距 |
|---|---|---|
| 資產與格式 | DAT、FDTXT/字型、RLE、AFM/FIGANI、XMIDI、地圖資料可抽取／解碼；33 張地圖均已由雜湊吻合的 FDFIELD／FDSHAP 同步構成格目標旗標、blit mode 與地形控制列 | 版權資產不入庫；部分資源的 runtime compositor 尚未接到 Ebiten |
