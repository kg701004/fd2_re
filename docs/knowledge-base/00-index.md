...
> ## ⚠ 先讀這個：[`SESSION-HANDOFF-2026-09-19.md`(最新)](SESSION-HANDOFF-2026-09-19.md)
>
> 更早的：[`SESSION-HANDOFF-2026-09-18.md`](SESSION-HANDOFF-2026-09-18.md)／[`SESSION-HANDOFF-2026-09-10.md`](SESSION-HANDOFF-2026-09-10.md)／[`SESSION-HANDOFF-2026-09-04.md`](SESSION-HANDOFF-2026-09-04.md)／[`SESSION-HANDOFF-2026-09-03.md`](SESSION-HANDOFF-2026-09-03.md)
>
> **2026-09-02 `remake/` 已依使用者指示整個移除**（commit `b090ddeb`）。本索引與下列
> 所有文件裡「remake 實作／parity／M1-M6 里程碑」相關的敘述，除非標註在該日之後，
> 一律是**移除前的歷史狀態**。RE 側（格式、資料、機制、工具）不受影響，照常有效。
> 新 session 接手請先讀上面那份交接文件再往下讀，否則容易照著已不存在的東西工作。
