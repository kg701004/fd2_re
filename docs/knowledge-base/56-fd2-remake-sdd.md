...
| UI-03 | Action menu | move/attack/magic/item/status/wait/end-turn 的可見項、enable gate、取消回上一層 | partial；原版 action overlay 的 raw cell selection／四幀 slide ABI 已閉合，但 anchor／renderer 接線與 end-turn 可見流程仍缺 |
