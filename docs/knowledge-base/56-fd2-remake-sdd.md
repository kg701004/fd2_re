...
| UI-10 | Church | revive、class change、費率、候選過濾、確認／取消、缺資料 fail-closed | partial；`reviveChurchUnit`／`leaveChurch` 與 `town_ch02→church_ch02→town_ch02` trace 已接，未接 callee 仍明確擋下 |
