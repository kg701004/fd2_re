...
| 商店(一般商品) | `0x2e341→0x2f0b0/0x2f642/0x2f883/0x2f8ea`、doc56 UI-09 | 🟡 | 69個原版shop節點以`native_hub_variant`選擇1/3/5 production owner；stable、service menu、purchase list、Yes/No／取消及不足金生命週期已取代generic入口。recipient/success/debit仍只到E1 compositor，其他三個service與DOSBox E2未閉合；custom variant 0保留generic fallback | 高；完成購買recipient→success→debit，再接sell/equip/transfer owner |
