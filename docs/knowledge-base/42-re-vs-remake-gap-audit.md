...
| 商店(一般商品) | `0x2e341→0x2f0b0/0x2f642/0x2f883/0x2f8ea`、doc56 UI-09 | 🟡 | purchase與sell兩條production縱切已閉合；sell保存source/empty/3⁄4 price/confirm/success→credit→compact remove→recalc。高階Unit canonicalizes native stale tail item，故不宣稱save byte parity。equip/transfer與DOSBox E2未閉合；custom variant 0保留generic fallback | 高；接equip/transfer owner，再做E2 |
