...
| UI-02 field | map/camera/cursor/unit/HUD Draw 約 3441–3568、4571、4595；camera、absolute/visible cursor、HUD anchor/gates 與 FDOTHER #130 panel 已有直接原版資料流；ch26 event61 所需 view/HUD 已達 E1 | partial | 除 ch26 E1 切片外，ch02+ 的逐章 dynamic view/gates/anchor producer、同 roster/event/tick 的 DOSBox 像素差分，以及 `0x12c0d` 的 exact raw lookup predicate/order |
