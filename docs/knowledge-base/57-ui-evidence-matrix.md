...
| UI-10 church | `0x2d7bd` 左右四項循環、Enter/Space confirm、Esc cancel；`0x3072f` raw dispatch `0→0x2ffa5`、`1→0x2f8ea`、`2→0x30dc3`、`3→0x31385`。class path `0x31385→0x31793→0x311DC→0x19953` 已閉合 state/input：Lv>=20、portrait<0x12 且 !=7；三列可見角色候選、上下 bounded；special>optional>default 覆寫成唯一 target；左右 Yes/No 確認。`0x31019` 已接 FDICON、name/current class/FDTXT593/target class、palette201/205；FDOTHER#14 entry16=310×86，`0x1974c` opening y=`177,164,151,138,125,112` | partial/fail-closed | final indexed frame 已接 runtime並有原版資源 artifact；待六幀 draw-ack cadence、`0x19953/0x197e5` 確認框 renderer、`0x2d669` menu transition、raw index0 renderer/text與inventory flag export |
