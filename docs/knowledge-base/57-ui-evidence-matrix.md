...
| weapon/item shop | 35–45% | 主選單已能以原版 FDOTHER/FDTXT/DATO 組出；四個callee已由writer定案為purchase/sell/equip/transfer。`0x2e0bd→0x2dc55(mode0)` purchase child panel亦能畫兩欄六項、icon/name/stat/full price，nonzero mode為3⁄4 price。production仍是現代文字清單，recipient/equip/feedback完整 lifecycle、variant文字與 DOSBox E2 尚未接 |
...
| UI-09 shop | mixed-container/stable scene/menu compositor已有original-resource regression。四項service均有direct writer證據；`0x2e0bd` entry16 panel＋`0x2dc55` mode0/full、mode!=0/3⁄4 rows已有typed compositor及purchase screenshot | partial | recipient/equip/feedback panels的完整opening/closing、production owner、secret shop flag、variant cancel semantics與DOSBox E2 |
