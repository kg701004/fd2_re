...
| town hub | 85–90% | ch02 variant0 selection0–5 均取得原版 DOSBox E2，且各自能和 production remake 某個 pulse 的 320×200 raw RGB MD5 整幀相同；Left/Right wrap、Shift+F1 hidden reveal、selection5後Enter進variant5 secret shop皆由原版 input trace 到達。variant1/2與secret shop返回town仍待 E2 |
| weapon/item/secret shop | 85–90% | 69個shop節點已用variant 1/3/5啟用indexed owner；四項service production owner均已接。ch02 secret variant5 service0 phase0/2已達原版DOSBox與production remake raw RGB整幀AE=0；E2並抓出及修正service pulse雙重`/2`。仍缺service1–3 input/return與variant1/3同狀態E2 |
