...
| UI-10 church | `0x2d7bd` 左右四項循環、Enter/Space confirm、Esc cancel；`0x3072f` raw dispatch `0→0x2ffa5`、`1→0x2f8ea`、`2→0x30dc3`、`3→0x31385`。class path `0x31385→0x31793→0x311DC→0x19953` 已閉合 state/input。`0x31019` 已接 FDICON、name/current class/FDTXT593/target class、palette201/205；FDOTHER#14 entry16=310×86，`0x1974c` opening y=`177,164,151,138,125,112`。`0x19953` 的 FFFC=name substitution、FDOTHER#2 opening cells16/17、interactive cells48/49及51/52、x=`248±spread`/y168與 `0x197e5` closing均已成 compositor | partial/fail-closed | candidate/confirmation final indexed frames 已接 runtime並有原版資源 artifacts；待 draw-ack／BIOS pulse cadence、`0x2d669` menu transition、raw index0 renderer/text與inventory flag export |
