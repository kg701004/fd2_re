...
| UI-04 target/range | `0x1cff0` direct caller 證實 command record `+3/+4/+6` 參與 spell/target geometry；remake movement/attack/spell selection 已有，item action 約 2475 仍提示未實裝 | partial/missing | `0x149f8` family priority、weapon structure reach、AOE/LOS、不可用目標灰化 |
