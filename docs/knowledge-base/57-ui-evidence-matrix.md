...
| weapon/item shop | 45–50% | 主選單、商品child panel、購買確認／不足金、type≥`0x20`兩欄名冊及type<`0x20`三列AP/DP/HIT/EV裝備比較均有原版資源indexed fixture；滿欄回饋保存`word_5265f`＋動態姓名。四個callee已由writer定案。production仍是現代文字清單；success/equip/debit runtime owner與 DOSBox E2 未接 |
...
| UI-09 shop | mixed-container/stable scene/menu、purchase rows/confirm/insufficient已有original-resource regression。type≥`0x20`接`0x2e6b8`兩欄六人；type<`0x20`接filtered三列AP/DP/HIT/EV current→candidate與6-open/5-close；滿欄接`word_5265f`動態姓名 | partial | success/equip/debit production owner、secret shop flag、variant cancel semantics與DOSBox E2 |
