...
| town hub | 80–90% | ch02 variant0 selection0–5 均取得原版 DOSBox E2，且各自能和 production remake 某個 pulse 的 320×200 raw RGB MD5 整幀相同；Left/Right wrap 與 Shift+F1 hidden reveal 亦由原版 input trace 到達。variant1/2 與 hidden confirm→secret shop 仍待 E2 |
