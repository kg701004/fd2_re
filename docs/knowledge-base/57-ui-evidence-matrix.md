...
| UI-10 church | `0x2d7bd` 左右四項循環、Enter/Space confirm、Esc cancel；`0x3072f` raw dispatch `0→0x2ffa5`、`1→0x2f8ea`、`2→0x30dc3`、`3→0x31385`。class path `0x31385→0x31793→0x311DC→0x19953` 已閉合 state/input。`0x31019` 已接 FDICON、name/current class/FDTXT593/target class、palette201/205；FDOTHER#14 entry16=310×86，`0x1974c` opening y=`177,164,151,138,125,112`，六幀均由 Draw acknowledgement 推進。`0x19953` 的 FFFC=name substitution、FDOTHER#2 opening cells16/17、interactive cells48/49及51/52、x=`248±spread`/y168與 `0x197e5` closing均已成 compositor：opening／closing 各四個 acknowledged presents，Yes mutation 與 No／Esc 返回只在 closing 完成後執行；BIOS delta>=2 時 counter=(counter+1) mod4，選中 variant=counter/2。`0x2d669/0x2d85f` 的 104×20 clear、FDOTHER#14 entries3..10、四幀開關 divisor、兩-tick pulse與selected pair已成 indexed primitive | partial/fail-closed | 合成`0x3072f` entry1＋DATO＋FDTXT585/586完整scene後接church menu runtime；raw index0 renderer/text與inventory flag export |
