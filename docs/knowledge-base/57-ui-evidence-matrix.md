...
| weapon/item shop | 30–40% | `0x2e341→0x1956b→0x2d669/0x2d9fe` 已能以原版 FDOTHER/FDTXT/DATO 組出店內背景、variant portrait、藍框、八位 gold、greeting、四項服務圖示 opening geometry與selected pulse；production shop 仍是現代文字清單，商品/recipient child lifecycle、callee語意閉合與 DOSBox E2 尚未接 |
...
| UI-09 shop | buy/sell/equip/recipient 約 2256–2391；`0x2e341` 的 FDOTHER#12/#29/#63 mixed-container、`0x1956b` dialogue-grid／DATO variant portrait、cell1 decoration、八位 gold與FDTXT#440/#501 stable compositor已有original-resource regression；`0x2d669→0x4e9e4` 四項 raw literal icons、`[-39,-13,13,39]` spread及`0x2d9fe` selected odd/even pulse亦已有indexed fixture | partial | 四個service callee語意、商品/recipient child panels、production owner、secret shop flag、原版 cancel semantics與DOSBox E2 |
