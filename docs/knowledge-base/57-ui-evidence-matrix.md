...
| UI-06 HUD | native map HUD `0x1acf3` 已釘 display gates、LMI1 #130(69×34) at row157、terrain/AP/DP offsets（AP row8 col43；DP row19 col43）及依正負選 #0x83/#0x84、取絕對值後 decimal-digit 的 raw path；remake 尚畫 full-screen #22 approximation | partial | #0x83/#0x84 artwork semantics、optional unit icon/HP resource、raw anchor globals 的高階語意、native asset/runtime adapter 與 320×200 ground truth |
