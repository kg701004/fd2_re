...
| UI-03 action menu | Docker Capstone `0x18890` + `0x18d8c`：↑0 attack、←1 spell、→2 item、↓3 wait/field interaction；remake `ringInput` 約 2407 已改同序；item branch `0x1bbdc` selector/equip/transfer partially traced | partial | `0x1cff0` command/effect table、`0x20c6f` item effect path、完整 enable gate、end-turn entry |
