...
| weapon/item shop | 60–65% | 69個原版shop節點已用variant 1/3/5明確啟用indexed owner；stable/menu/list/confirm/不足金、兩欄consumable recipient、三列equipment比較recipient、取消與滿欄回饋均已接production生命週期。equipment preview要求raw inventory及`EquipmentBaseSet`，明確補`+0x37/+0x39` base AP/DP。`0x2f4c6`三種success仍只有E1 fixture；insert/equip/debit、其餘三service與DOSBox E2待閉合 |
...
| UI-09 shop | stable/menu、purchase rows/confirm/insufficient、兩種recipient與滿欄均有original-resource regression及production owner；缺raw identity/inventory/equipment-base provenance fail-closed。`0x2f4c6` shop variants1/3/5分別為5/1/7幀、不同anchor/wait/portrait restore；optional-equip→success→debit→product-loop順序已保存 | partial | insert/equip/success/debit production timeline、其他三service與DOSBox E2 |
