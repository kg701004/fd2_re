...
| UI-09 shop | purchase、sell、standalone equip與transfer均有original-resource regression及production owner；strict adapters在raw projection不完整時fail-closed。secret gate保存23筆normal selection與Shift/Ctrl/Alt-F1..F10 BIOS scan，直接進variant5而非顯示永久第六項 | partial | variant1/3/5同狀態DOSBox E2；secret chord與town restore實機diff |
