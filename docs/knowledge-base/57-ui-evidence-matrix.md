...
| UI-10 church | `0x2d7bd` 左右四項循環、Enter/Space confirm、Esc cancel；`0x3072f` raw dispatch `0→0x2ffa5`、`1→0x2f8ea`、`2→0x30dc3`、`3→0x31385`；remake selector 已對齊左右 ABI | partial/fail-closed | `0x2d669` indexed menu transition adapter、未命名 service callee 的完整 fee/candidate/確認與 renderer |
