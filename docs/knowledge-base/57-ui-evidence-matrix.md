...
| weapon/item shop | 80–85% | 69個原版shop節點已用variant 1/3/5啟用indexed owner；purchase含no-eligible與完整transaction。sell亦已接source roster、empty feedback、3/4 item list、question、success→credit→compact remove→recalc；display/commit共用raw price。剩餘equip/transfer兩service及DOSBox E2 |
...
| UI-09 shop | purchase與sell均有original-resource regression及production owner；缺raw identity/inventory/equipment-base provenance fail-closed。sell保存FDTXT508/509 variant tables、3/4 price、success後credit/remove/recalc與actor selection | partial | equip/transfer production owner與DOSBox E2 |
