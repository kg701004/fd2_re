...
| raw byte writer / spawn intro | 0x32975(slot)=整 byte 覆寫1；0x32999(group)=spawn+12-step present | 完整 callee body ✅；constructor 0x10eed 寫0 | raw_byte5_write / spawn_intro | ✅ |
