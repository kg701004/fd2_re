...
### 9.26.4 對 `91-worklist.md` L1017-1020 的最新影響
**新增**:`FUN_0002fb2c`(9輪迴圈+1額外呼叫的渲染編排函式)定位,其額外呼叫是立繪本體的**候選**
但未定案;`DAT_000615fe`表語意訂正為姓名代入+MV加成(非portrait選擇器,撤回§9.25.7的猜測)。
**仍未查清**:`FUN_000111ba()`的資源索引語意、`FUN_0002fb2c`額外呼叫的 live 交叉核對、
portrait框完全未觸及。**維持D**,範圍已收斂到「1個具體候選函式+2個明確下一步」。(worklist 稽核索引「660」——原版全程無任何顯示縮放/內插程式碼)(2026-08-24)
