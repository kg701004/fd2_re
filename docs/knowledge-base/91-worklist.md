...
- [x] **ch15 candidate editable CFG**：新增 `handlers/ch15_post_cfg.json`，保留 raw source addresses 與 nested OR/else branch；僅作候選腳本，camera/layout/96-slot/raw constructor provenance 未閉合前不建立 active binding。
