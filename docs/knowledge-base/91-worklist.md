...
- [x] **shared native damage route IDs0..12**：IDA `sub_2134B/364/37D`、`21449/462/47B` 與 `21494` 皆進 shared `21227/213B7`，ID9 亦 direct `1CA89→1C75E`；IDs10..12 的 `0x21548` 專用 compositor 尾端也直接 `1CA89→per-target 1C75E`。同樣扣 MP、逐 target numeric writer、success acted；engine bounded support 0..12，UI 未擴張。
