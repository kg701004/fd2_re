...
- [x] **SDD native command family matrix**：`56` 現以 IDs 0..35 的 dataflow、strict engine slice、UI/renderer gate 三欄固定 0..27 已證實 family 與 24／28..35 禁止接線邊界；不得以 label、raw record 或 generic dispatch 把未知 ID 借接 legacy `CastArea`。
