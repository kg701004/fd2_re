...
- [x] **撤回 `0x1f882`=vsync/sync helper**：Docker Capstone 展開 `ebx=0..63`、每次 `0x11d40(0,255,ebx)`＋2ms wait，故是 64-step native palette fade-out。它與 `0x25052/0x11df2` 的 delta ramp 不同；indexed DAC adapter 未完成前保持 fail-closed。
