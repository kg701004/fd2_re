...
- [x] **shared native damage route IDs0..3**：IDA `sub_2134B/364/37D` 僅 push 1/2/3 並跳 `sub_2121A→sub_21227`，同樣扣 MP、逐 target `0x1c75e`、success acted；engine bounded support 0..3，UI 未擴張。
