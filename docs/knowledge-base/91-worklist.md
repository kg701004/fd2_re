...
605 - E - 與587同一項目(UI音效index 2-0xb語意畫面實測)，同理需live驗證。 **2026-09-07**：與 587 同一項目，本輪的呼叫端語意 + 波形量測 + 觸發時機三源對照結果一併適用，見 item 587 與 `docs/data/ui_sfx_index_semantics.json`。我先前「需要使用者實聽」的說法是錯的，已更正。
