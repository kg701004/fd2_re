...
def native_constructor_for_portrait(tables, portrait):
    ...
    portrait outside an evidenced table remains absent rather than indexing
    adjacent EXE data.  No record byte receives a gameplay name here.
    """
    if not tables:
        return None
    if portrait >= 0x44:
        branch, index = "high_class", portrait - 0x44
    else:
        branch, index = "lower_class", portrait
