...
// route used by IDs 26 and 27: 0x22CBF/0x22E41 -> 0x22CDA -> 0x22D1B.
...
// rand()%4+2 to +0x25 (ID26) or +0x26 (ID27).  It intentionally does not map
// either offset onto the legacy named status approximation.
