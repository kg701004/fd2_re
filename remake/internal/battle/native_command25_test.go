...
func TestExecuteNativeCommand25ClearsOnlyFinalActedTargets(t *testing.T) {
	...
	got, err := st.ExecuteNativeCommand25(actor, confirmed, nil)
...
func TestExecuteNativeCommand25FailsBeforeMPOnInvalidConfirmation(t *testing.T) {
	...
	if _, err := st.ExecuteNativeCommand25(actor, confirmed, nil); err == nil || actor.MP != 5 || actor.Acted || !confirmed.Acted {
