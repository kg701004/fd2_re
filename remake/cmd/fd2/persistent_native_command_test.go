...
func TestApplyPersistentStatsPreservesDynamicNativeCommandMask(t *testing.T) {
	...
	src := &battle.Unit{NativeCommandMask: [5]byte{0x81, 0x01, 0, 0x80, 0x11}, NativeRecordByte5: 1, HasNativeRecordByte5: true, NativeRecordByte6: 7, HasNativeRecordByte6: true, NativeRecordWord42: 0x140, HasNativeRecordWord42: true}
